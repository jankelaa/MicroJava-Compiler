...
public class StatementSingleNoLabel extends Statement {

    private SingleStatement SingleStatement;

    public StatementSingleNoLabel (SingleStatement SingleStatement) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("StatementSingleNoLabel(\n");
